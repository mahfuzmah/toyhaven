                                        ...
                                        <a href="#" data-bs-toggle="dropdown"
                                           class="nav-link pe-2 leading-none d-flex animate">
                                            ...
                                            <div class="text-center p-1 d-flex d-lg-none-max">
                                                <h6 class="mb-0" id="profile-heading">RASEKUL<i
                    ...
                    <ul class="side-menu">
                        ...
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon"
                                     enable-background="new 0 0 24 24" viewBox="0 0 640 640">
                                    <path
                        ...
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                ...
                                <span class="side-menu__label">Sub Categroy Module</span><i
                                    class="angle fa fa-angle-right"></i></a>
                            <ul class="slide-menu">
                                <li><a href="{{route('sub-category.create')}}" class="slide-item">Add Sub Category</a>
                                </li>
                                <li><a href="{{route('sub-category.index')}}" class="slide-item">Manage Sub Category</a>
                                </li>
                            </ul>
                        </li>
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                ...
                                <span class="side-menu__label">Brands Module</span><i
                                    class="angle fa fa-angle-right"></i></a>
                            <ul class="slide-menu">
                                <li class="side-menu-label1"><a href="#">Add Brands</a></li>
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                ...
                                <li><a href="{{route('unit.create')}}" class="slide-item">Create Module</a></li>
                                <li><a href="{{route('unit.index')}}" class="slide-item">Manage Module</a></li>
                            </ul>
                        </li>
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                <li><a href="{{route('couriers.index')}}" class="slide-item">Manage Courier</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                <li><a href="typography.html" class="slide-item">Manange Customer</a></li>
                            </ul>
                        </li>
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="#">
                            ...
                            <ul class="slide-menu">
                                <li><a href="typography.html" class="slide-item">Setting Module</a></li>
                            </ul>
                        </li>
                    </ul>
