                ...
                <form class="form-horizontal" action="{{ route('sub-category.update', $sub_category->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-9">
                            ...
                            <input class="form-control" id="firstName" value="{{$sub_category->name}}" placeholder="Enter Sub-Category Name" type="text" name="name">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-9">
                            <textarea name="description" class="form-control"  placeholder="Enter Sub-Category Description">{{$sub_category->description}}</textarea>
                        </div>
                    </div>
                    <div class="row mb-4">
                        ...
                        <div class="col-md-9">
                            ...
                            <img src="{{asset($sub_category->image)}}" alt="" height="100" width="105">
                        </div>
                    </div>
                    <div class="row mb-4">
