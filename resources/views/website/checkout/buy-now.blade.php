                                                    ...
                                                    <div class="ul-mt15">
                                                        <div class="checkitem-img width-88">
                                                            <div class="position-relative">
                                                                <img src="{{ asset($product->image) }}" class="w-100 img-fluid border-radius" alt="cart-1">
                                                            ...
                                                            <div class="checkitem-detail h-100 d-flex flex-column justify-content-between">
                                                                ...
                                                                <div class="checkitem-price mst-12 text-end">
                                                                    <div class="heading-color heading-weight">
                                                                        ৳{{ number_format($product->selling_price * 1, 2) }}
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="checkout-cost mst-30 pst-30 bst">
                                            ...
                                            <div class="row row-mtm20">
                                                <div class="col-12 d-flex justify-content-between">
                                                    ...
                                                    <input type="hidden" id="subTotalValue" value="{{ $product->selling_price }}"/>
                                                    <span id="totalValue" class="heading-color heading-weight">{{ $sum }}</span>
                                                </div>

                                                <div class="col-12 d-flex justify-content-between">
                                                    <span>Tax</span>
                                                    <span id="taxValue" class="text-success heading-weight"> {{ $tax = round(($sum * 0.0) )}}</span>
                                                </div>
                                                <div class="col-12 d-flex justify-content-between">
                                                    <span>Shipping</span>
                                                ...
                                                <div class="col-12 d-flex justify-content-between">
                                                    <span>Total</span>
                                                    <span id="totalAmountFee" class="heading-color heading-weight"><span id="totalRes">{{$sum + $tax + $shipping}}</span></span>
