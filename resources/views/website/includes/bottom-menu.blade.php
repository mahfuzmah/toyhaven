<div class="bottom-menu d-md-none position-sticky bottom-0 body-bg z-1 box-shadow">
    <div class="bottom-menu-element d-flex flex-wrap align-items-center">
        <div class="col">
            <a href="{{route('home')}}" class="d-flex flex-column align-items-center ptb-10 text-center">
        ...
        <div class="col">
            <a href="{{route('customer.login')}}" class="d-flex flex-column align-items-center ptb-10 text-center">
        ...
        <div class="col">
            <a href="{{route('products.all')}}" class="d-flex flex-column align-items-center ptb-10 text-center">
        ...
        <div class="col">
            <a href="{{route('customer.wishlist')}}" class="d-flex flex-column align-items-center ptb-10 text-center">
                        <span class="bottom-menu-icon-wrap position-relative per-8">
                            ...
                            <span class="bottom-menu-counter wishlist-counter extra-color font-10 position-absolute end-0 primary-bg d-flex align-items-center justify-content-center rounded-circle">{{ $totalWishlist }}
                                <script>
        ...
        <div class="col">
            <a href="javascript:void(0)" class="js-cart-drawer d-flex flex-column align-items-center ptb-10 text-center">
                        <span class="bottom-menu-icon-wrap position-relative per-8">
                            ...
                            <span class="bottom-menu-counter cart-counter extra-color font-10 position-absolute end-0 primary-bg d-flex align-items-center justify-content-center rounded-circle">{{ count(Cart::content()) }}</span>
                        </span>
