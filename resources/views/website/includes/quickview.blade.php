                ...
                <div class="row row-mtm quickview-modal-content">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <div class="quickview-info p-md-relative height-md-100">
                            <div class="quickview-detail-info p-md-absolute top-0 bottom-0 start-0 psl-md-3 per-md-30">
                                <div class="quick-info" data-animate="animate__fadeIn">
                                    <div class="product-title">
                                        <h2 class="product-name font-20"></h2>
                                    </div>
                                </div>
                                ...
                                <div class="quick-info mst-15" data-animate="animate__fadeIn">
                                    <div class="product-availability">
                                        <span class="d-inline-block text-success"><span class="heading-color heading-weight">Availability:</span> <span class="stock-status">In stock</span></span>
                                    </div>
                                </div>
                                    ...
                                    <div class="product-quantity-action">
                                        ...
                                        <div class="product-action mst-15">
                                            <div class="row btn-row15">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <a href="javascript:void(0)" class="w-100 btn-style secondary-btn form-buy-now" id="quick-view-buy-now">
                                                        Buy Now
                                                    </a>
                                                </div>
                                            </div>
                                ...
                                <div class="quick-info mst-15" data-animate="animate__fadeIn">
                                    <div class="ul-row">
                                        <div class="product-wishlist">
                                            <a href="javascript:void(0)" class="add-to-wishlist heading-color" id="quick-view-wishlist"><i class="ri-heart-line icon-16 mer-4"></i><span class="heading-weight">Wishlist</span></a>
                                        </div>
                                        <div class="product-compare">
                                            <a href="#" class="add-to-compare heading-color"><i class="ri-stack-line icon-16 mer-4"></i><span class="heading-weight">Compare</span></a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <!--                <a href="javascript:void(0)" class="d-block"><img src="{{asset('/')}}website/assets/image/other/paying-visa.png" class="width-40 img-fluid border-radius" alt="paying-visa"></a>-->
                            <!--                 <a href="javascript:void(0)" class="d-block"><img src="{{asset('/')}}website/assets/image/other/paying-maestro.png" class="width-40 img-fluid border-radius" alt="paying-maestro"></a>-->
                            <!--                <a href="javascript:void(0)" class="d-block"><img src="{{asset('/')}}website/assets/image/other/paying-american.png" class="width-40 img-fluid border-radius" alt="paying-american"></a>-->
                            <!--                 <a href="javascript:void(0)" class="d-block"><img src="{{asset('/')}}website/assets/image/other/union_pay.png" class="width-40 img-fluid border-radius" alt="union_pay"></a>-->





                            <!--                <a href="javascript:void(0)" class="d-block"><img src="{{asset('/')}}website/assets/image/other/nagad.jpg" class="width-40 img-fluid border-radius" alt="paying-nagad"></a>-->
                            <!--                <a href="javascript:void(0)" class="d-block"><img src="{{asset('/')}}website/assets/image/other/bkash.jpg" class="width-40 img-fluid border-radius" alt="paying-bkash"></a>-->
                            <!--                <a href="javascript:void(0)" class="d-block"><img src="{{asset('/')}}website/assets/image/other/abbank.jpg" class="width-40 img-fluid border-radius" alt="paying-abbank"></a>-->
                            <!--                <a href="javascript:void(0)" class="d-block"><img src="{{asset('/')}}website/assets/image/other/bankasia.jpg" class="width-40 img-fluid border-radius" alt="paying-bankasia"></a>-->
                            <!--                <a href="javascript:void(0)" class="d-block"><img src="{{asset('/')}}website/assets/image/other/cellfin.jpg" class="width-40 img-fluid border-radius" alt="paying-cellfin"></a>-->
                            <!--                <a href="javascript:void(0)" class="d-block"><img src="{{asset('/')}}website/assets/image/other/citytouch.jpg" class="width-40 img-fluid border-radius" alt="citytouch"></a>-->
                            <!--                <a href="javascript:void(0)" class="d-block"><img src="{{asset('/')}}website/assets/image/other/dbbl apps nexus pay 2017.jpg" class="width-40 img-fluid border-radius" alt="dbbl apps nexus pay "></a>-->
                            <!--                <a href="javascript:void(0)" class="d-block"><img src="{{asset('/')}}website/assets/image/other/rocket.jpg" class="width-40 img-fluid border-radius" alt="rocket"></a>-->
                            <!--                <a href="javascript:void(0)" class="d-block"><img src="{{asset('/')}}website/assets/image/other/eblsky.jpg" class="width-40 img-fluid border-radius" alt="eblsky"></a>-->
                            <!--                <a href="javascript:void(0)" class="d-block"><img src="{{asset('/')}}website/assets/image/other/fastcash.jpg" class="width-40 img-fluid border-radius" alt="fastcash"></a>-->
                            <!--                <a href="javascript:void(0)" class="d-block"><img src="{{asset('/')}}website/assets/image/other/FsiblCloudLogo.jpg" class="width-40 img-fluid border-radius" alt="FsiblCloudLogo"></a>-->
                            <!--                <a href="javascript:void(0)" class="d-block"><img src="{{asset('/')}}website/assets/image/other/ibbl.jpg" class="width-40 img-fluid border-radius" alt="ibbl"></a>-->
                            <!--                <a href="javascript:void(0)" class="d-block"><img src="{{asset('/')}}website/assets/image/other/ibblmobile.jpg" class="width-40 img-fluid border-radius" alt="ibblmobile"></a>-->
                            <!--                <a href="javascript:void(0)" class="d-block"><img src="{{asset('/')}}website/assets/image/other/instapay.jpg" class="width-40 img-fluid border-radius" alt="instapay"></a>-->
                            <!--                <a href="javascript:void(0)" class="d-block"><img src="{{asset('/')}}website/assets/image/other/modhumoti.jpg" class="width-40 img-fluid border-radius" alt="modhumoti"></a>-->
                            <!--                <a href="javascript:void(0)" class="d-block"><img src="{{asset('/')}}website/assets/image/other/mtbl.jpg" class="width-40 img-fluid border-radius" alt="mtbl"></a>-->
                            <!--                <a href="javascript:void(0)" class="d-block"><img src="{{asset('/')}}website/assets/image/other/okwallet.jpg" class="width-40 img-fluid border-radius" alt="okwallet"></a>-->
                            <!--                <a href="javascript:void(0)" class="d-block"><img src="{{asset('/')}}website/assets/image/other/pmoney.jpg" class="width-40 img-fluid border-radius" alt="pmoney"></a>-->
                            <!--                <a href="javascript:void(0)" class="d-block"><img src="{{asset('/')}}website/assets/image/other/qcash.jpg" class="width-40 img-fluid border-radius" alt="qcash"></a>-->
                            <!--                <a href="javascript:void(0)" class="d-block"><img src="{{asset('/')}}website/assets/image/other/tap.jpg" class="width-40 img-fluid border-radius" alt="tap"></a>-->
                            <!--                <a href="javascript:void(0)" class="d-block"><img src="{{asset('/')}}website/assets/image/other/tap.jpg" class="width-40 img-fluid border-radius" alt="tap"></a>-->
                            <!--                <a href="javascript:void(0)" class="d-block"><img src="{{asset('/')}}website/assets/image/other/upay.jpg" class="width-40 img-fluid border-radius" alt="upay"></a>-->
                            <!--                <a href="javascript:void(0)" class="d-block"><img src="{{asset('/')}}website/assets/image/other/woori.jpg" class="width-40 img-fluid border-radius" alt="woori"></a>-->
                                <!--            </li>-->
                                <!--        </ul>-->
                                ...
                                <div class="quick-info mst-10">
                                    <div class="product-view-link">
                                        <a href="" class="view-full-details d-inline-block font-12">
                                            <i class="ri-file-info-line mer-4"></i>
                                            <span class="text-decoration-underline">View all this products</span>
                                        </a>
                                    </div>
                                </div>
                            </div>
