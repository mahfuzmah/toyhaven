...
@section('body')
    ...
    <div class="breadcrumb-area ptb-30 bg-img text-center"
         data-bgimg="{{asset('/')}}website/assets/image/other/Untitled-1-01.png">
        <div class="container">
            ...
            <div class="container">
                <div class="row row-mtm">
                    ...
                    <div class="article-img banner-hover" data-animate="animate__fadeIn">
                        <img src="{{asset('/')}}website/assets/image/article/2.jpg"
                    ...
                    <div class="article-title" data-animate="animate__fadeIn">
                        ...
                        <h2 class="font-24">শিশুদের মস্তিষ্ক বিকাশ: কেন গুরুত্বপূর্ণ এবং কীভাবে দ্রুত উন্নতি ঘটে</h2>
                    </div>
                    <!-- article-title end -->
                        ...
                        <div class="row row-mtm">
                            <div class="article-desc">
                                <div class="article-detail p-mtm30">
                                    <p>শিশুর জন্মের পর থেকেই তার মস্তিষ্ক দ্রুত বিকাশ শুরু করে। জীবনের প্রথম কয়েক বছরকে
                                        বলা হয় “Brain Development Window”, যেখানে শেখা, বুঝা, চিন্তা, আচরণ, ভাষা — সব
                                        কিছুর ভিত্তি তৈরি হয়। তাই এই সময়ে সঠিক পরিবেশ, পুষ্টি ও যত্ন শিশুদের ভবিষ্যৎকে
                                        আরো শক্তিশালী করে।</p>
                                </div>
                            </div>
                                ...
                                <div class="article-blockquote">
                                    <blockquote class="m-0">
                                        ...
                                        <h6 class="font-20 section-heading-family section-heading-text section-heading-weight">
                                            খেলাই শিশুর সবচেয়ে প্রাকৃতিক শেখার উপায়। ব্লক, পাজল, রং করা, গল্প সাজানো—
                                            এসব খেলা তার সমস্যা সমাধান, মনোযোগ ও সৃজনশীল চিন্তা বাড়ায়।
                                            যেসব খেলায় হাত ও চোখ একসাথে কাজ করে (যেমন ব্লক দিয়ে ঘর বানানো, বল ছোড়া),
                                            সেগুলো মস্তিষ্কের সংযোগ আরও শক্ত করে।
                                            এছাড়া বাইরে খেলা, দৌড়ানো বা প্রকৃতির মাঝে সময় কাটানো শিশুর মানসিক শান্তি ও
                                            ফোকাস বাড়ায়।</h6>
                                    </blockquote>
                                </div>
                            </div>
                            ...
                            <div class="article-desc">
                                <div class="article-detail p-mtm30">
                                    <h3>শিশুর মস্তিষ্ক বিকাশ কীভাবে হয়?</h3>
                                    <p>জন্মের পর থেকেই শিশুর মস্তিষ্কের নিয়ুরন কানেকশন বা “Brain Connection” তৈরি হতে থাকে। প্রতিটি স্পর্শ, শব্দ, রং, হাসি, খেলনা — সবকিছুই মস্তিষ্কে নতুন সিগন্যাল পাঠায়।
                                        এই সিগন্যালগুলো বারবার তৈরি হলে মস্তিষ্ক আরও শক্তিশালী ও সক্রিয় হয়।
                                    </p>
                                    <br>
                                    <h3>মস্তিষ্ক বিকাশে প্রভাব ফেলে যেসব বিষয়</h3>
                                    <p class="justify-content-center text-center">১. পুষ্টিকর খাবার
                                        •	মায়ের দুধ
                                        •	ওমেগা-৩ সমৃদ্ধ খাবার (ডিম, মাছ)
                                        •	ফল ও সবজি
                                        এসব খাবার মস্তিষ্কের গঠন ও স্মৃতিশক্তি বৃদ্ধিতে সহায়তা করে।
                                    </p>
                                    <br>
                                    <h3>২. নিরাপদ ও ভালোবাসাময় পরিবেশ</h3>
                                    <p class="justify-content-center">শিশু যত বেশি ভালোবাসা ও নিরাপত্তা পায়, তত দ্রুত তার স্নায়ুতন্ত্র শক্তিশালী হয়।</p>
                                    <h3>৩. পর্যাপ্ত ঘুম</h3>
                                    <p class="justify-content-center">শঘুমের সময় মস্তিষ্ক নতুন তথ্য প্রক্রিয়া করে এবং শিখে নেয়। শিশুদের জন্য পর্যাপ্ত ঘুম অত্যন্ত জরুরি।</p>
                                    <h3>৪. শেখা ও খেলা </h3>
                                    <p class="justify-content-center">খেলার মাধ্যমে শিশু সবচেয়ে দ্রুত শেখে।
                                        রং চিনা, ব্লক সাজানো, শব্দযুক্ত খেলনা, পাজল — এসব খেলনা মস্তিষ্কের বিভিন্ন অংশ একসঙ্গে কাজ করতে শেখায়।
                                    </p>
                                    <h3>খেলনার ভূমিকা মস্তিষ্ক বিকাশে</h3>
                                    <p class="justify-content-center">খশিশুর বয়স অনুযায়ী সঠিক খেলনা তার
                        ...
                        <div class="article-pn ptb-15 bst beb">
                            <ul class="article-pn-ul d-flex align-items-center justify-content-between">
                                <li class="article-pn-li">
                                    <a href="{{route("blog")}}" class="primary-link font-14 d-flex align-items-center"><i
                                            class="ri-arrow-left-line icon-16 mer-5"></i><span
                                            class="text-uppercase heading-weight">Prev post</span></a>
                                </li>
                                <li class="article-pn-li">
                                    <a href="{{route("blog3")}}" class="primary-link font-14 d-flex align-items-center"><span
