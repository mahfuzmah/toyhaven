...
@section('body')
    ...
    <div class="breadcrumb-area ptb-30 bg-img text-center" data-bgimg="{{asset('/')}}website/assets/image/other/Untitled-1.jpg">
        <div class="container">
            ...
            <h2 class="extra-color font-24 font-xl-32 mst-5 mst-xl-9">{{ $title ?? 'Category View' }}</h2>
        </div>
    </div>
    <!-- breadcrumb-area end -->
    <!-- main start -->
                                        ...
                                        <ul class="shop-filters ul-mtm-15">
                                            <li>
                                                <label class="cust-checkbox-label d-flex align-items-center justify-content-between">
                                                    <input type="checkbox" id="shop-in-stock" name="stock_amount" class="cust-checkbox" value="1" {{ request('stock_amount') ? 'checked' : '' }}>
                                ...
                                <div class="shop-sidebar price">
                                    ...
                                    <div class="shop-header d-flex justify-content-between mst-21">
                                        <div class="shop-header d-flex justify-content-between mst-21">
                                            ...
                                            @endphp
                                            <span class="shop-selected" style="font-size: 14px">The highest price is TK. {{ $maxDbPrice }}</span>
                                        </div>
                                        <a href="{{ url()->current() }}" class="shop-reset body-secondary-color text-decoration-underline" style="font-size: 14px"><span class="position-relative">Reset</span></a>
                                    </div>
                                        ...
                                        <div class="price-input-range">
                                            ...
                                            <div class="price-input d-flex align-items-center mst-30">
                                                <div class="price-field position-relative w-100">
                                                    ...
                                                    <input type="number" id="min-price" name="min_price" class="min-input w-100 h-100 text-end" min="0" max="10000" value="{{ request('min_price', 0) }}">
                                                </div>
                                                ...
                                                <div class="price-field position-relative w-100">
                                                    ...
                                                    <input type="number" id="max-price" name="max_price" class="max-input w-100 h-100 text-end" min="0" max="10000" value="{{ request('max_price', 10000) }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                        ...
                                                        @foreach($specialProducts as $specialProduct)
                                                            <div class="single-product-wrap d-flex flex-wrap">
                                                                <div class="width-120 product-image">
                                                                    <a href="{{route('product', ['id' => $specialProduct->id])}}" class="pro-img"><img src="{{asset($specialProduct->image)}}" class="w-100 img-fluid" alt="p-1"></a>
                                                                </div>
                                                                <div class="width-calc-120 product-content">
                                                                    <div class="pro-content">
                                                                        <div class="product-title">
                                                                            <span class="d-block"><a href="{{route('product', ['id' => $specialProduct->id])}}" class="d-block w-100 primary-link text-truncate heading-weight">{{$specialProduct->name}}</a></span>
                                                                        </div>
                                                                        <div class="product-price">
                                                                            <div class="price-box heading-weight">
                                                                                <span class="new-price primary-color">TK. {{$specialProduct->regular_price}}</span>
                                ...
                                <div class="col-12">
                                    <div class="row row-mtm15">
                                        ...
                                        <div class="collection-title">
                                            <h6 class="font-18">{{ $title ?? 'Category View' }}</h6>
                                        </div>
                                        ...
                                        <div class="shop-top-bar">
                                            <div class="row row-mtm15 align-items-md-center">
                                                ...
                                                <div class="col-12 col-sm-6 col-md-5 col-lg-4">
                                                    <input type="hidden" name="sortby" id="sortInput" value="{{ request('sortby','created-descending') }}">
                                                    ...
                                                    <div class="shop-short d-flex flex-wrap position-relative">
                                                        ...
                                                        <select id="sortby_mobile" class="d-xl-none width-calc-64 h-auto ptb-0 bg-transparent border-0" onchange="document.getElementById('sortInput').value = this.value; document.getElementById('shopForm').submit();">
                                                            <option value="manual" {{ request('sortby') == 'manual' ? 'selected' : '' }}>Featured</option>
                ...
                @endphp
                                                        ...
                                                        <ul class="collapse position-absolute top-100 start-0 end-0 ptb-5 body-bg z-1 DropDownSlide br-hidden box-shadow" id="select-wrap">
                                                            @foreach($sorts as $value => $label)
                                                                <li class="{{ request('sortby', 'created-descending') == $value ? 'selected' : '' }}">
                                                                    <a href="javascript:void(0)" data-value="{{ $value }}" class="sort-option d-block ptb-5 plr-15 {{ request('sortby', 'created-descending') == $value ? 'secondary-color extra-bg' : 'body-primary-color' }}">
                                                                        {{ $label }}
                                                                    </a>
                                                                </li>
                                                            @endforeach
                                                        ...
                                                        <div class="row single-product-wrap">
                                                            ...
                                                            <div class="product-image-col">
                                                                <div class="product-image">
                                                                    <a href="{{ route('product', $product->id) }}" class="pro-img">
                                                                    ...
                                                                    <div class="product-action-wrap">
                                                                        <div class="product-action">
                                                                            ...
                                                                            <a href="{{ route('add-to-wishlist',$product->id) }}" class="add-to-wishlist">
                                            ...
                                            <i class="ri-eye-line icon-16"></i>
                                                            ...
                                                            <div class="product-content">
                                                                <div class="pro-content">
                                                                    ...
                                                                    <div class="product-title">
                                                                        <a href="{{ route('product',$product->id) }}" class="primary-link heading-weight">
                                                                            {{ $product->name }}
                                                                        </a>
                                                                    </div>
