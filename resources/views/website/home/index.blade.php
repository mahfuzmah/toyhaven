                ...
                <div class="home-slider swiper" id="home-slider">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="bg-img d-flex flex-wrap text-center" data-bgimg="{{asset('/')}}website/assets/image/index/slider-bgimg3.jpg">
                                <div class="col-12 col-lg-4 d-flex flex-column align-items-center justify-content-center section-ptb plr-15 plr-md-30 slider-content-info">
                                    ...
                                    <a href="{{route('products.all')}}" class="btn-style primary-btn mst-20 mst-sm-23 mst-xl-34 mst-xxl-38">Shop collection</a>
                                </div>
                                <div class="col-6 col-lg-4 order-lg-first">
                                    <span class="d-inline-block slider-content-img1"><img src="{{asset('/')}}website/assets/image/index/child-care-ymca-family-child-development-child-d8d3eeeac1c71f9c6b954d0f6f016f6c.png" class="w-100 img-fluid" alt="slider-1.1"></span>
                                </div>
                                <div class="col-6 col-lg-4">
                                    <span class="d-inline-block slider-content-img2"><img src="{{asset('/')}}website/assets/image/index/favpng_8245b3e678264a33d79009fc032e0419.png" class="w-100 img-fluid" alt="slider-1.2"></span>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                @foreach($categories as $category)
                                    <div class="swiper-slide h-auto d-flex" data-animate="animate__fadeIn">
                                        <div class="cat-block banner-hover w-100 ptb-15 plr-15 body-bg border-radius">
                                            <a href="{{route('category', ['id' => $category->id])}}" class="d-none d-xl-block position-relative banner-img br-hidden">
                                                ...
                                                <img src="{{asset($category->image)}}" class="w-100 img-fluid" alt="collection-1">
                                            </a>
                                            <a href="{{route('category', ['id' => $category->id])}}" class="d-block d-xl-none banner-img br-hidden">
                                                <img src="{{asset($category->image)}}" class="w-100 img-fluid" alt="collection-1">
                                            </a>
                                            <div class="cat-content pst-15">
                                                <div class="ul-mtm15 justify-content-between heading-weight">
                                                    <a
                                                        href="{{route('category', ['id' => $category->id])}}"><span class="heading-color  text-truncate">{{$category->name}} </span></a>
                                                    <span class="primary-color text-uppercase"></span>
                                                </div>
                                                <div class="d-xl-none mst-7">
                                                    <a href="{{route('category', ['id' => $category->id])}}" class="link-btn">Shop now</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="scroll-text ptb-10 primary-bg overflow-hidden">
            <div class="d-flex">
                <div class="scroll-text-row scroll-text-left d-flex align-items-center">
                    ...
                    <span class="width-24 msl-15" data-animate="animate__fadeIn"><img src="{{asset('/')}}website/assets/image/index/scroll-text-img1.png" class="w-100 img-fluid" alt="scroll-text-img1"></span>
        ...
        <div class="scroll-text ptb-10 extra-bg overflow-hidden">
            <div class="d-flex">
                <div class="scroll-text-row scroll-text-right d-flex align-items-center">
                    ...
                    <span class="width-24 msl-15" data-animate="animate__fadeIn"><img src="{{asset('/')}}website/assets/image/index/scroll-text-img2.png" class="w-100 img-fluid" alt="scroll-text-img2"></span>
                                                            ...
                                                            <div class="product-image-col">
                                                                <div class="product-image">
                                                                    <a href="{{route('product', ['id' => $product->id])}}" class="pro-img">
                                                                            <img src="{{asset($product->image)}}" class="w-100 img-fluid img1" alt="p-1">
                                                                    </a>
                                                                    <div class="product-action-wrap">
                                                                        <div class="product-action">
                                                                            <a href="{{ route('add-to-wishlist',['id' => $product->id]) }}" class="add-to-wishlist">
                                                                ...
                                                                <div class="pro-content">
                                                                    <div class="product-title">
                                                                        ...
                                                                        <span class="d-block heading-weight">
                                                                            <a href="{{route('product', ['id' => $product->id])}}" class="primary-link">{{$product->name}}</a>
                                                                        </span>
                                                                    </div>
                                                                    <div class="product-price">
                                                                        <div class="price-box heading-weight">
                                                                            <span class="new-price primary-color">TK. {{$product->selling_price}}</span>
                        ...
                        <div class="row row-mtm100 gx-0">
                            <div class="col-12">
                                <div class="collection-wrap">
                                                        ...
                                                        <div class="row single-product-wrap">
                                                            <div class="product-image-col">
                                                                ...
                                                                <div class="product-content">
                                                                    <div class="pro-content">
                                                                        <div class="product-title">
                                                                            <span class="d-block meb-7">{{$product->category->name}}</span>
                                                                            <span class="d-block heading-weight">
                                                                                <a href="{{route('product', ['id' => $product->slug])}}" class="primary-link">{{$product->name}}</a>
                                                                            </span>
                                                                        </div>
                                                                        <div class="product-price">
                                                                            <div class="price-box heading-weight">
                                    ...
                                    <div class="view-button" data-animate="animate__fadeIn">
                                        <a href="{{route('products.all')}}" class="btn-style tertiary-btn">View All Items</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="blog-slider swiper" id="blog-slider-full">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide" data-animate="animate__fadeIn">
                                        <div class="blog-post banner-hover">
                                            <div class="blog-main-img">
                                                <a href="{{route('blog')}}" class="d-none d-xl-block position-relative banner-img br-hidden">
                                                    ...
                                                    <img src="{{asset('/')}}website/assets/image/newsletter/blog-1.jpg" class="w-100 img-fluid" alt="a-2">
                                                </a>
                                            ...
                                            <div class="blog-post-content pst-25">
                                                ...
                                                <div class="d-xl-none mst-9">
                                                    <a href="{{route('blog')}}" class="link-btn"> আরও পড়ুন... </a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide" data-animate="animate__fadeIn">
                                        <div class="blog-post banner-hover">
                                            <div class="blog-main-img">
                                                <a href="{{route('blog2')}}" class="d-none d-xl-block position-relative banner-img br-hidden">
                                                    <span class="btn-style tertiary-btn banner-btn position-absolute top-50 start-50 translate-middle z-1 text-nowrap">আরও পড়ুন...</span>
                                                    <img src="{{asset('/')}}website/assets/image/newsletter/blog-2.jpg" class="w-100 img-fluid" alt="a-2">
                                                </a>
                                                <a href="#" class="d-block d-xl-none banner-img br-hidden">
                                                    <img src="{{asset('/')}}website/assets/image/newsletter/blog-2.jpg" class="w-100 img-fluid" alt="a-2">
                                                </a>
                                            ...
                                            <div class="blog-post-content pst-25">
                                                ...
                                                <div class="d-xl-none mst-9">
                                                    <a href="{{route('blog2')}}" class="link-btn"> আরও পড়ুন... </a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide" data-animate="animate__fadeIn">
                                        <div class="blog-post banner-hover">
                                            <div class="blog-main-img">
                                                <a href="{{route('blog3')}}" class="d-none d-xl-block position-relative banner-img br-hidden">
                                                    <span class="btn-style tertiary-btn banner-btn position-absolute top-50 start-50 translate-middle z-1 text-nowrap">আরও পড়ুন...</span>
                                                    <img src="{{asset('/')}}website/assets/image/newsletter/blog-3.jpg" class="w-100 img-fluid" alt="a-2">
                                                </a>
                                                <a href="#" class="d-block d-xl-none banner-img br-hidden">
                                                    <img src="{{asset('/')}}website/assets/image/newsletter/blog-3.jpg" class="w-100 img-fluid" alt="a-2">
                                                </a>
                                            ...
                                            <div class="blog-post-content pst-25">
                                                ...
                                                <div class="d-xl-none mst-9">
                                                    <a href="{{route('blog3')}}" class="link-btn"> আরও পড়ুন... </a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="row row-mtm100">
                                                    ...
                                                    <div class="row single-product-wrap">
                                                        ...
                                                        <div class="product-content">
                                                            <div class="pro-content">
                                                                <div class="product-title">
                                                                    <span class="d-block meb-7"></span>
                                                                    <span class="d-block heading-weight"><a href="{{route('product', ['id' => $product->id])}}" class="primary-link">{{$product->name}}</a></span>
                                                                </div>
                                                                <div class="product-price">
                                                                    <div class="price-box heading-weight">
                                                                        <span class="new-price primary-color">TK. {{$product->selling_price}}</span>
                        ...
                        <div class="col-12 col-lg-6 col-xl-5">
                            ...
                            <div class="category-product-banner height-lg-100 position-relative banner-hover br-hidden">
                                <a href="#" class="d-block height-lg-100 banner-img"><img src="{{asset('/')}}website/assets/image/index/product-banner2.jpg" class="w-100 height-lg-100 img-fluid" alt="product-banner2"></a>
                                <div class="position-absolute bottom-0 start-0 end-0 meb-30 meb-xl-50 mlr-15 mlr-md-30 mlr-xxl-50">
                                    <div class="category-product-banner-content d-flex justify-content-center">
                                        <a href="{{route('products.all')}}" class="btn-style tertiary-btn">Shop now</a>
                                    </div>
                                </div>
                            </div>
                            <!-- category-product-banner start -->
