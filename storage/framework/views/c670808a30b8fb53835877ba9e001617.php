                    ...
                    <div class="col-12 col-lg-8 p-lg-sticky top-0">
                        <div class="cart-itemview">
                            <div class="cart-title d-flex align-items-center justify-content-between peb-30 beb"
                                ...
                                <span class="cart-count"><span class="cart-counter"><?php echo e($total_qty); ?></span> Items</span>
                            </div>
                            <div class="cart-table">
                                ...
                                <?php ($sum=0); ?>
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $cart_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cart_product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="cart-table-data" wire:key="<?php echo e($cart_product->rowId); ?>">
                                                ...
                                                <div class="col-12 col-md-5">
                                                    ...
                                                    <div class="cart-item-content d-flex flex-wrap">
                                                        <div class="cart-item-image width-88">
                                                            <a href="<?php echo e(route('product', ['id' => $cart_product->id])); ?>"
                                                               target="_blank" class="d-block br-hidden"><img
                                                                    src="<?php echo e(asset($cart_product->options->image)); ?>"
                                                                    class="w-100 img-fluid" alt="cart-1"></a>
                                                        </div>
                                                        <div class="cart-item-info width-calc-88 psl-15">
                                                            <a href="<?php echo e(route('product', ['id' => $cart_product->id])); ?>"
                                                               target="_blank"
                                                               class="primary-link heading-weight"><?php echo e($cart_product->name); ?></a>
                                                            <span
                                                                class="d-block heading-color mst-7 heading-weight">TK. <?php echo e($cart_product->price); ?></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="js-qty-wrapper">
                                                        <div class="count-input">
                                                                ...
                                                                <div class="input-group">
                                                                    <input type="number" 
                                                                           wire:model.live.debounce.200ms="quantities.<?php echo e($cart_product->rowId); ?>" 
                                                                           class="form-control" 
                                                                           min="1"
                                                                           required/>
                                                                </div>
                                            ...
                                            <div class="row row-mtm20">
                                                <div class="col-12 d-flex justify-content-between">
                                                    ...
                                                    <span class="heading-color heading-weight">Tk. <span
                                                            id="totalValue"><?php echo e($sum); ?></span> </span>
                                                </div>
                                                <div class="col-12 d-flex justify-content-between">
                                                    <span>Discount</span>
                                                    <span class="text-danger heading-weight"
                                                          id="taxValue"><?php echo e($tax = round( ($sum * 0) )); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="cart-cost mst-30 pst-30 bst">
                                            <div class="row row-mtm20">
                                                <div class="col-12 d-flex justify-content-between">
                                                    <span>Total</span>
                                                    <span class="heading-color heading-weight">Tk.  <span
                                                            id="totalRes"><?php echo e($sum + $tax); ?></span> </span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="cart-button mst-30">
                                        <a href="<?php echo e(route('checkout.index')); ?>" class="w-100 btn-style secondary-btn">Checkout</a>
                                                    ...
                                                    <div class="product-image">
                                                        ...
                                                        <div class="product-action-wrap">
                                                            <div class="product-action">
                                                                <a href="<?php echo e(route('add-to-wishlist',['id' => $product->id])); ?>"
                                                    ...
                                                    <div class="pro-content">
                                                        <div class="product-title">
                                                            ...
                                                            <span class="d-block heading-weight">
                                                                    <a href="<?php echo e(route('product', ['id' => $product->id])); ?>"
                                                                       class="primary-link"><?php echo e($product->name); ?></a>
                                                                </span>
                                                        </div>
                                                        <div class="product-price">
                                                            <div class="price-box heading-weight">
                                                                <span
                                                                    class="new-price primary-color">TK. <?php echo e($product->selling_price); ?></span>
...
<?php /**PATH C:\toyhaven\resources\views/livewire/cart-page.blade.php ENDPATH**/ ?>