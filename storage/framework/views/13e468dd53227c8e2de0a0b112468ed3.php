                                                    ...
                                                    <div class="ul-mt15">
                                                        <div class="checkitem-img width-88">
                                                            <div class="position-relative">
                                                                <img src="<?php echo e(asset($product->image)); ?>" class="w-100 img-fluid border-radius" alt="cart-1">
                                                            ...
                                                            <div class="checkitem-detail h-100 d-flex flex-column justify-content-between">
                                                                ...
                                                                <div class="checkitem-price mst-12 text-end">
                                                                    <div class="heading-color heading-weight">
                                                                        ৳<?php echo e(number_format($product->selling_price * 1, 2)); ?>
                                        ...
                                        <div class="checkout-cost mst-30 pst-30 bst">
                                            ...
                                            <div class="row row-mtm20">
                                                <div class="col-12 d-flex justify-content-between">
                                                    <span>Subtotal</span>
                                                    <?php ( $sum = $product->selling_price * 1); ?>
                                                    <input type="hidden" id="subTotalValue" value="<?php echo e($product->selling_price); ?>"/>
                                                    <span id="totalValue" class="heading-color heading-weight"><?php echo e($sum); ?></span>
                                                </div>

                                                <div class="col-12 d-flex justify-content-between">
                                                    <span>Tax</span>
                                                    <span id="taxValue" class="text-success heading-weight"> <?php echo e($tax = round(($sum * 0.0) )); ?></span>
                                                </div>
                                                <div class="col-12 d-flex justify-content-between">
                                                    <span>Shipping</span>
                                                        <span class="text-success heading-weight">
                                                            <select id="shippingCost"><style>#shippingCost {color: green; }</style>
                                                ...
                                                <div class="col-12 d-flex justify-content-between">
                                                    <span>Total</span>
                                                    <span id="totalAmountFee" class="heading-color heading-weight"><span id="totalRes"><?php echo e($sum + $tax + $shipping); ?></span></span>
                                                ...
                                                <div class="acc-detail mst-21">
                                                    ...
                                                    <div class="acc-detail-button mst-20 mst-md-30">
                                                        <div class="row btn-row">
                                                            <div class="col-12">
                                                                <button type="submit" class="w-100 acc-save btn-style secondary-btn">
                                                                    PLACE ORDER
                                                                </button>
                                                            </div>
                                                        </div>
...
<?php echo $__env->make('website.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\toyhaven\resources\views/website/checkout/buy-now.blade.php ENDPATH**/ ?>