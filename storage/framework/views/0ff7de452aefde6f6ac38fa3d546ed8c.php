        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-3 col-md-10 offset-md-1 col-12">
                    <form class="card login-form" <?php echo e(route('customer.login')); ?> method="post">
                        <?php echo csrf_field(); ?>
                        <div class="card-body">
                            <div class="title">
                                <h3>Login Now</h3>
                                <p>You can login using your social media account or email address.</p>
                                <p class="text-danger text-center"><?php echo e(session('message')); ?></p>
                            </div>
                            ...
                            <p class="outer-link">Don't have an account? <a href="<?php echo e(route('customer.register')); ?>">Register here </a>
                            </p>
                        </div>
                    </form>
                </div>
...
<?php echo $__env->make('website.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\toyhaven\resources\views/website/auth/login.blade.php ENDPATH**/ ?>