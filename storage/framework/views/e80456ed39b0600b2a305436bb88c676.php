                        ...
                        <div class="col-6 col-xl-2 header-element header-logo">
                            <div class="header-theme-logo">
                                <a href="<?php echo e(route('home')); ?>" class="d-inline-block theme-logo">
                                    <img src="<?php echo e(asset('/')); ?>website/assets/image/index/Untitled-1-01.png"
                                                    ...
                                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <li class="menudrop-li position-relative">
                                                            <div class="menu-sublink ptb-5 plr-30">
                                                                ...
                                                                <span
                                                                    class="menusub-title width-calc-16"><?php echo e($category->name); ?></span>
                                                            ...
                                                            <div class="col-lg-2 col-md-4 col-sm-6 mb-4">
                                                                <div class="ptb-5 heading-weight">
                                                                    <a style="color: black; font-weight: bold; font-size: 15px;"
                                                                       href="<?php echo e(route('category', ['id' => $category->id])); ?>"><?php echo e($category->name); ?></a>
                                                                </div>
                                                                <?php $__currentLoopData = $category->subCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <span class="d-block ptb-2">
                                                                        <a href="<?php echo e(route('subCategory', ['id' => $subCategory->id])); ?>"
                                                                           ...
                                                                           style="font-size: 14px;"><?php echo e($subCategory->name); ?></a>
                                                                    </span>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </div>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <ul class="ul-mt15 flex-nowrap align-items-center header-icon-element">
                                    ...
                                    <li class="header-icon-wrap user-wrap d-md-block d-none">
                                        <?php if(Session::get('customer_id')): ?>
                                            <div class="header-icon-wrapper">
                                                <a href="<?php echo e(route('customer.dashboard')); ?>" class="d-block header-icon-user"
                                        ...
                                        <?php else: ?>
                                            <a href="<?php echo e(route('customer.login')); ?>" class="d-block header-icon-user"
                                               aria-label="Login user">
                                            <span class="d-block header-block-icon primary-link font-16 font-xl-20"><i
                                                    class="ri-user-line"></i></span>
                                        <?php endif; ?>
                                    ...
                                    <li class="header-icon-wrap wishlist-wrap d-md-block d-none">
                                        <div class="header-icon-wrapper">
                                            <a href="<?php echo e(route('customer.wishlist')); ?>" class="d-block header-icon-wishlist">
                                                    <span class="primary-link ul-mt5 flex-nowrap align-items-center">
                                                        <span class="d-block">
                                                            <span class="d-block header-block-icon-wrap position-relative per-8">
                                                               ...
                                                               <span class="header-block-counter wishlist-counter extra-color font-10 position-absolute end-0 d-flex align-items-center justify-content-center primary-bg rounded-circle"><?php echo e($totalWishlist); ?></span>
                                                            </span>
                                                        </span>
...
[$__name, $__params] = $__split('header-cart');

$__html = app('livewire')->mount($__name, $__params, 'lw-475787911-0', $__slots ?? [], get_defined_vars());
...
<!-- header end -->
<?php /**PATH C:\toyhaven\resources\views/website/includes/header.blade.php ENDPATH**/ ?>